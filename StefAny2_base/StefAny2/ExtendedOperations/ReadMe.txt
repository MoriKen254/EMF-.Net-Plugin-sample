========================================================================
    ダイナミック リンク ライブラリ: ExtendedOperations プロジェクトの概要
========================================================================

この ExtendedOperations DLL は、AppWizard により作成されました。

このファイルには、ExtendedOperations アプリケーションを構成する各ファイルの内容の概要が含まれています。

ExtendedOperations.vcxproj
...
ExtendedOperations.vcxproj.filters
