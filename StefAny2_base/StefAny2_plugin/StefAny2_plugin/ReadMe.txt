========================================================================
    ダイナミック リンク ライブラリ: StefAny2_plugin プロジェクトの概要
========================================================================

この StefAny2_plugin DLL は、AppWizard により作成されました。

このファイルには、StefAny2_plugin アプリケーションを構成する各ファイルの内容の概要が含まれています。

StefAny2_plugin.vcxproj
...
StefAny2_plugin.vcxproj.filters
